	...
	final class Npcink_Cloud_Addon_Localization {
		...
		public static function translations(): array {
			return array(
				...
				'Allow Npcink Cloud to reference indexed public articles during WordPress AI title generation so suggestions better match this site\'s writing style. WordPress content is not changed.' => '允许 Npcink Cloud 在 WordPress AI 生成标题时参考已索引的公开文章，使建议更贴近本站写作风格。不会更改 WordPress 内容。',
				'AI generation reference' => 'AI 生成参考',
				'enabled for title generation' => '已为标题生成启用',
				'Monitoring' => '监控',
