...
maca_assert(
	...
	&& false !== strpos( $settings_page, 'render_diagnostic_group_heading' )
	&& false !== strpos( $settings_page, 'data-diagnostic-panel-group' )
	&& false !== strpos( $settings_page, "'local_configuration'" )
	&& false !== strpos( $settings_page, "'cloud_connectivity'" )
	&& false !== strpos( $settings_page, "'signed_transport'" )
	&& false !== strpos( $settings_page, "'entitlement_readiness'" )
	&& false !== strpos( $settings_page, "'support_facts'" )
